...
- 新しい ADR を書く前に、関連する既存 ADR、コードパターン、プロジェクト規約を読む。
...
- 新規 ADR には実装計画と検証基準を含める。
- ADR 確定前に `references/review-checklist.ja.md` でレビューする。
- ADR がコーディングエージェントに何を変更し、何を維持し、どのように完了確認するかを伝えられない場合は、書く前または受け入れる前に追加の意図を確認する。
