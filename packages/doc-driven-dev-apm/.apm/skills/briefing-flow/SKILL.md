...
> and specifies invocation resolution. Generated by `sdp scan`, agent review/update of
> inference entries, `sdp infer`, and `sdp profile`, then validated by `sdp validate`.
