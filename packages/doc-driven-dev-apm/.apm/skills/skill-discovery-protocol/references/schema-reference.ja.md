...
本文書は Adapter YAML スキーマ、invocation 解決ルール、
scan 集約、classification 検証、および execution policy を記述する。
...
## 2. Invocation Resolution 規約

### 2.1 `resolved_invocations` 生成規約
