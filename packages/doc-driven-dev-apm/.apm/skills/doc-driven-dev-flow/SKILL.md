...
description: "Meta skill that orchestrates the full document-driven development lifecycle. Selects and sequences existing doc skills (idea-refine, brainstorming, spec-doc, adr-doc, design-doc, plan-doc, task-doc, doc-status) through a fixed 5-phase flow with explicit gates."
license: MIT
---
...
sequencing existing doc skills through a 5-phase flow with explicit gates.
...
7. **Exit Audit** — invoke `doc-status` to validate document integrity.
